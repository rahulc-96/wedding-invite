...
const UNIT_STYLE = { border: '1px solid rgba(226,189,148,.4)', padding: '14px 4px' };
const LABEL_STYLE = {
  fontSize: 10,
  letterSpacing: '.24em',
...
export function Countdown() {
  ...
  return (
    <section style={{ padding: '58px 30px', background: '#7a1c2e', color: '#f7eee1', textAlign: 'center' }}>
      <p style={{ margin: '0 0 22px', fontSize: 12, letterSpacing: '.4em', textTransform: 'uppercase', color: '#e2bd94' }}>
        Wedding in
      </p>
